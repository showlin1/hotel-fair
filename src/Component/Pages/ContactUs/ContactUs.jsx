                    ...
                    <div>
                        <div className="flex-1 lg:flex lg:items-center bg-white">
                            <div className="lg:w-1/2 shadow-lg">
                                <h1 className="font-bold text-rose-500 capitalize  text-3xl p-5">
                                ...
                                <div className="mt-6 space-y-8 md:mt-8 p-5">
                                    ...
                                    <p className="flex items-start -mx-2">
                                        ...
                                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">showlinakter77@gmail.com</span>
                                    </p>
                                </div>
                            ...
                            <div className="mt-8 lg:w-1/2 lg:mx-6">
                                <div className="w-full p-5 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                                    <h1 className="text-2xl font-semibold text-rose-500 dark:text-gray-200">Contact form</h1>
                                    ...
                                    <form className="mt-6">
                                        <div className="flex-1">
                                            ...
                                            <input type="text" placeholder="John Doe" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border  rounded-md dark:bg-gray-900 dark:text-gray-300 border-rose-300 focus:outline-rose-500" />
                                        </div>

                                        <div className="flex-1 mt-6">
                                            <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email address</label>
                                            <input type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-rose-300 focus:outline-rose-500 rounded-md dark:bg-gray-900 dark:text-gray-300 " />
                                        </div>

                                        <div className="w-full mt-6">
                                            <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Message</label>
                                            <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 border-rose-300 focus:outline-rose-500" placeholder="Message"></textarea>
                                        </div>

                                        <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-rose-500 rounded-md hover:bg-rose-600 focus:outline-none focus:ring focus:ring-rose-400 focus:ring-opacity-50">
                                            get in touch
                                        </button>
                                    </form>
                                </div>
