...
const AboutUs = () => {
    return (
        <div className="py-24 px-3 container mx-auto">
            ...
            <section>
                <div className='py-16'>
                    <h1 className='text-4xl font-bold text-primary text-center '>Spend Happy Holidays <br />
                        With Us</h1>
                </div>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                    <div className='grid grid-cols-2 transition-all gap-6'>
                        <div className='text-center space-y-3 p-5 hover:bg-primary duration-300 hover:text-white'>
                        ...
                        <div className='text-center space-y-3 hover:bg-primary duration-300 hover:text-white p-5'>
                    ...
                    <div className='space-y-5'>
                        <h1 className='text-6xl font-bold text-primary'>Unwind A Hotel Booking Agency</h1>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                        <button className='border-2 border-primary text-primary hover:bg-primay duration-300 transition hover:text-white text-xl font-bold px-6 py-3'>View Our Rooms</button>
                    </div>
                </div>
            </section>
        </div>
